package com.brahim.nammouchi.gestioncommande;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] allTopics = {"name","article1", "article2", "article3", "article4"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoSaisie.setOnItemClickListener((AdapterView.OnItemClickListener) (adapterView, view, i, l) -> {
    ...
    public void getArticle(final String commandName) {
        allCommande.clear();
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Commande c = new Commande();
                c = dataSnapshot.child(commandName).getValue(Commande.class);
